...
class _SendSMSToDueCustomerState extends State<SendSMSToDueCustomer> {
  ...
  DueCustomerMsgController.text = "Dear Customer,A-ONE IMPEX ${widget.CustomerPhoneNumber} Ac No. এ ${widget.BikePaymentDue}৳ টাকা বকেয়া আছে। ${widget.BikeDuePaymentGivingDay}/${DateTime.now().month.toString()}/${DateTime.now().year.toString()} তারিখের মধ্যে পরিশোধ করুন। ধন্যবাদ";
                        ...
                        Container(width: 150, child:TextButton(onPressed: () async{
                          ...
                          Future SendSMSToCustomer(context, String CustomerNID, String CustomerPhoneNumber, String BikePaymentDue, String DueCustomerMsg) async {
                            ...
                            final response = await http
                                .get(Uri.parse('https://api.greenweb.com.bd/api.php?token=1024519252916991043295858a1b3ac3cb09ae52385b1489dff95&to=${CustomerPhoneNumber}&message=${DueCustomerMsg}'));
