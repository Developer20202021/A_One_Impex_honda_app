...
class CreditPdfPreview extends StatefulWidget {


final List CreditData;
final String TotalCreditAmount;

 const CreditPdfPreview({super.key,  required this.CreditData, required this.TotalCreditAmount});

  @override
  State<CreditPdfPreview> createState() => _CreditPdfPreviewState();
}

class _CreditPdfPreviewState extends State<CreditPdfPreview> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      systemOverlayStyle: SystemUiOverlayStyle(
        ...
        title: const Text("ব্যয়ের খাতা", style: TextStyle(fontFamily: "Josefin Sans", fontWeight: FontWeight.bold),),
            ...
            pw.Row(
             ...
             pw.SizedBox(
              ...
              pw.Center(child:pw.Container(
                ...
                child: pw.Center(child: pw.Text("e¨‡qi cwigvb", style:pw.TextStyle(fontSize: 20,  font: Banglattf, color: PdfColor.fromInt(0x000000))))) ),
                       ...
                       pw.TableRow(
                        decoration: pw.BoxDecoration(color: PdfColors.grey100),
                          children: [
                            ...
                            pw.Padding(
                              child: pw.Text("${CreditData[x]["CreditName"]}", style:pw.TextStyle(fontSize: 11, fontWeight: pw.FontWeight.bold,font: Banglattf,  color: PdfColor.fromInt(0x000000))),
                              padding: pw.EdgeInsets.all(4),
                            ),


                              pw.Padding(
                              child: pw.Text("${CreditData[x]["CreditAmount"]}", style:pw.TextStyle(fontSize: 11,font: Banglattf, fontWeight: pw.FontWeight.bold, color: PdfColor.fromInt(0x000000))),
                              padding: pw.EdgeInsets.all(4),
                            ),
                  ...
                  children: [
                    ...
                    pw.Container(
                      ...
                      child: pw.Padding(padding:pw.EdgeInsets.only(
                        top: 10,right:10,
                        bottom:10, left: 10),child: pw.Text("${CreditTotalAmount} UvKv", style:pw.TextStyle(fontSize: 10, fontWeight: pw.FontWeight.bold, font: Banglattf, color: PdfColor.fromInt(0x000000)))))
                ])
