...
class DuePayPDFPreview extends StatefulWidget {


final List PaymentData;

 const DuePayPDFPreview({super.key,  required this.PaymentData});

  @override
  State<DuePayPDFPreview> createState() => _DuePayPDFPreviewState();
}

class _DuePayPDFPreviewState extends State<DuePayPDFPreview> {
...
@override
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: PdfPreview(
        build: (context) => makePdf(widget.PaymentData),
      ),
    );
  }
}
          ...
          child: pw.Column(children: [
            ...
            pw.Row(
                ...
                children: [
                  ...
                  pw.Text("${SalesData[0]["FileNo"]}"),


                  pw.Text("Date: ${SalesData[0]["PaymentDate"]}"),
          ...
          pw.SizedBox(height: 15),
              ...
              pw.Row(
                ...
                children: [
                  ...
                  pw.Text("NID", style: pw.TextStyle(fontSize: 11,)),
                ...
                decoration:  pw.BoxDecoration(
                border: pw.Border(bottom: pw.BorderSide(width: 1, style: pw.BorderStyle.dashed))),
                    child: pw.Padding(padding: pw.EdgeInsets.only(bottom: 5, left: 30),child: pw.Text("${SalesData[0]["CustomerNID"]}", style: pw.TextStyle(fontSize: 14,))))
              ...
              pw.Row(
                ...
                children: [
                  ...
                  pw.Text("Receiver Name", style: pw.TextStyle(fontSize: 11,)),
                ...
                decoration:  pw.BoxDecoration(
                border: pw.Border(bottom: pw.BorderSide(width: 1, style: pw.BorderStyle.dashed))),
                    child: pw.Padding(padding: pw.EdgeInsets.only(bottom: 5, left: 30),child: pw.Text("${SalesData[0]["adminName"]}", style: pw.TextStyle(fontSize: 14,))))
              ...
              pw.Row(
                ...
                decoration:  pw.BoxDecoration(
                border: pw.Border(bottom: pw.BorderSide(width: 1, style: pw.BorderStyle.dashed))),
                    child: pw.Padding(padding: pw.EdgeInsets.only(bottom: 5, left: 30),child: pw.Text("${SalesData[0]["Amount"]} tk", style: pw.TextStyle(fontSize: 14,))))
