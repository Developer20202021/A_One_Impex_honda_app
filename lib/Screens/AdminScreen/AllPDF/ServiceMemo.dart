...
class ServiceMemoPDFPreview extends StatefulWidget {


final List CreditData;


 const ServiceMemoPDFPreview({super.key,  required this.CreditData,});

  @override
  State<ServiceMemoPDFPreview> createState() => _ServiceMemoPDFPreviewState();
}

class _ServiceMemoPDFPreviewState extends State<ServiceMemoPDFPreview> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      systemOverlayStyle: SystemUiOverlayStyle(
        ...
        title: const Text("সার্ভিস ফি", style: TextStyle(fontFamily: "Josefin Sans", fontWeight: FontWeight.bold),),
      ...
      body: PdfPreview(
        build: (context) => makePdf(widget.CreditData),
      ),
    );
  }
}
...
Future<Uint8List> makePdf(List CreditData) async {
            ...
            pw.Row(
             ...
             pw.SizedBox(
              ...
              pw.Center(child:pw.Container(
                ...
                child: pw.Center(child: pw.Text("mvwf©m wd", style:pw.TextStyle(fontSize: 20,  font: Banglattf, color: PdfColor.fromInt(0x000000))))) ),
                 ...
                 pw.Row(
                  ...
                  pw.Row(
                    ...
                    children: [
                      ...
                      pw.Text("dvBj bs", style:pw.TextStyle(fontSize: 12, fontWeight: pw.FontWeight.bold, font: Banglattf, color: PdfColor.fromInt(0x000000))),
                      ...
                      pw.TableRow(
                        decoration: pw.BoxDecoration(color: PdfColors.grey100),
                          children: [
                            ...
                            pw.Padding(
                              child: pw.Text("mvwf©‡mi bvg", style:pw.TextStyle(fontSize: 11, fontWeight: pw.FontWeight.bold, font: Banglattf, color: PdfColor.fromInt(0x000000))),
                              padding: pw.EdgeInsets.all(4),
                            ),
                            ...
                            pw.Padding(
                              child: pw.Text("‡gvevBj", style:pw.TextStyle(fontSize: 11, fontWeight: pw.FontWeight.bold, font: Banglattf, color: PdfColor.fromInt(0x000000))),
                              padding: pw.EdgeInsets.all(4),
                            ),


                              pw.Padding(
                              child: pw.Text("mvwf©m wd", style:pw.TextStyle(fontSize: 11, fontWeight: pw.FontWeight.bold, font: Banglattf, color: PdfColor.fromInt(0x000000))),
                              padding: pw.EdgeInsets.all(4),
                            ),
                       ...
                       pw.TableRow(
                        decoration: pw.BoxDecoration(color: PdfColors.grey100),
                          children: [
                            ...
                            pw.Padding(
                              child: pw.Text("${CreditData[x]["ServiceName"]}", style:pw.TextStyle(fontSize: 11, fontWeight: pw.FontWeight.bold, color: PdfColor.fromInt(0x000000))),
                              padding: pw.EdgeInsets.all(4),
                            ),


                            pw.Padding(
                              child: pw.Text("${CreditData[x]["CustomerPhoneNumber"]}", style:pw.TextStyle(fontSize: 11, fontWeight: pw.FontWeight.bold,  color: PdfColor.fromInt(0x000000))),
                              padding: pw.EdgeInsets.all(4),
                            ),


                              pw.Padding(
                              child: pw.Text("${CreditData[x]["ServiceAmount"]}", style:pw.TextStyle(fontSize: 11,fontWeight: pw.FontWeight.bold, color: PdfColor.fromInt(0x000000))),
                              padding: pw.EdgeInsets.all(4),
                            ),
                  ...
                  children: [
                    ...
                    pw.Container(
                      ...
                      child: pw.Padding(padding:pw.EdgeInsets.only(
                        top: 10,right:10,
                        bottom:10, left: 10),child: pw.Text("${CreditData[0]["ServiceAmount"]} UvKv", style:pw.TextStyle(fontSize: 10, fontWeight: pw.FontWeight.bold, font: Banglattf, color: PdfColor.fromInt(0x000000)))))
                ])
